...
export async function seedDatabase() {
  try {
    ...
    const conv1 = await ConversationRepository.create({ client_id: client1.id });
    ...
    const conv2 = await ConversationRepository.create({ client_id: client2.id });
    await MessageRepository.create({
    ...
    const conv3 = await ConversationRepository.create({ client_id: client3.id });
    await MessageRepository.create({
    ...
    const conv4 = await ConversationRepository.create({ client_id: client4.id });
    await MessageRepository.create({
