...
function createSimpleEmailBlocks(
  title: string,
  content: string,
  tips?: string[],
  ctaText?: string,
...
function generateEmailHTML(
  ...
  const layoutKeys = Object.keys(EMAIL_LAYOUTS) as Array<
    keyof typeof EMAIL_LAYOUTS
  >;
  ...
  const enhancedContent = enhanceContentWithLayoutModules(
    content,
    layout,
    primaryColor,
    secondaryColor,
...
function generateConsistentTemplate(
  ...
  const headerSubColor = layout.hasColoredHeader
  ...
  emails: [
    {
      ...
      htmlBody: "",
      textBody:
        "Your wedding planning adventure begins now with expert guidance every step of the way.",
    },
    {
      sequenceIndex: 1,
      ...
      htmlBody: "",
      textBody:
        "Define your unique style and create a cohesive vision for your perfect day.",
    },
    {
      sequenceIndex: 2,
      ...
      htmlBody: "",
      textBody:
        "Learn practical strategies for creating and managing your wedding budget effectively.",
    },
    {
      sequenceIndex: 3,
      ...
      htmlBody: "",
      textBody:
        "Essential tips for finding and booking the ideal venue for your celebration.",
    },
    {
      sequenceIndex: 4,
      ...
      htmlBody: "",
      textBody:
        "How to research, interview, and select the perfect vendors for your wedding day.",
    },
    {
      sequenceIndex: 5,
      ...
      htmlBody: "",
      textBody:
        "Understanding different photography styles to choose what's perfect for you.",
    },
    {
      sequenceIndex: 6,
      ...
      htmlBody: "",
      textBody:
        "Make the most of your engagement session with these expert preparation tips.",
    },
    {
      sequenceIndex: 7,
      ...
      htmlBody: "",
      textBody:
        "Navigate dress shopping like a pro with our insider guide to finding 'the one'.",
    },
    {
      sequenceIndex: 8,
      ...
      htmlBody: "",
      textBody:
        "Everything the groom needs to know about looking sharp on the wedding day.",
    },
    {
      sequenceIndex: 9,
      subject: "Wedding Menu & Catering Insights",
      weeksAfterStart: 8,
      daysAfterStart: 0.00625, // 9 minutes
      htmlBody: "",
      textBody:
        "Create a memorable dining experience that your guests will rave about.",
    },
    {
      sequenceIndex: 10,
      ...
      htmlBody: "",
      textBody:
        "Set the perfect mood with music and entertainment that reflects your style.",
    },
    {
      sequenceIndex: 11,
      ...
      htmlBody: "",
      textBody:
        "Transform your venue with beautiful florals and decor that tell your story.",
    },
    {
      sequenceIndex: 12,
      ...
      htmlBody: "",
      textBody:
        "Navigate the guest list challenge with tact and practical organization tips.",
    },
    {
      sequenceIndex: 13,
      ...
      htmlBody: "",
      textBody:
        "Create beautiful invitations that set the tone for your celebration.",
    },
    {
      sequenceIndex: 14,
      ...
      htmlBody: "",
      textBody:
        "Build a thoughtful registry that helps you start your married life together.",
    },
    {
      sequenceIndex: 15,
      ...
      htmlBody: "",
      textBody:
        "Plan the romantic getaway that marks the perfect start to married life.",
    },
    {
      sequenceIndex: 16,
      ...
      htmlBody: "",
      textBody:
        "Create a realistic timeline that ensures your day flows smoothly and stress-free.",
    },
    {
      sequenceIndex: 17,
      ...
      htmlBody: "",
      textBody:
        "Stay calm and centered on your wedding day with these proven stress-busting strategies.",
    },
    {
      sequenceIndex: 18,
      subject: "Final Wedding Week Checklist",
      weeksAfterStart: 21,
      daysAfterStart: 0.0125, // 18 minutes
      htmlBody: "",
      textBody:
        "Everything you need to do in the final week to ensure a flawless celebration.",
    },
    {
      sequenceIndex: 19,
      ...
      htmlBody: "",
      textBody:
        "Build strong relationships with your vendors for the best possible wedding day experience.",
    },
    {
      sequenceIndex: 20,
      ...
      htmlBody: "",
      textBody:
        "Plan the perfect rehearsal dinner to kick off your wedding celebration.",
    },
    {
      sequenceIndex: 21,
      ...
      htmlBody: "",
      textBody:
        "Start your wedding day perfectly with our morning preparation guide.",
    },
    {
      sequenceIndex: 22,
      ...
      htmlBody: "",
      textBody:
        "Savor every moment of your wedding day with these mindfulness tips.",
    },
    {
      sequenceIndex: 23,
      ...
      htmlBody: "",
      textBody:
        "Navigate post-wedding tasks and begin your happily ever after journey.",
    },
  ],
};

// Function to generate complete email content for wedding campaign
export function generateWeddingEmailContent(
  photographer: Photographer,
): StaticCampaignTemplate {
  ...
  const emailBlocksArray = [
    ...
    [
      ...
      { type: "SPACER", content: { height: 20 } },
      {
        type: "TEXT",
        content: {
          text: "This is such an exciting time, and we're absolutely thrilled to be part of your wedding planning journey.",
        },
      },
      { type: "SPACER", content: { height: 15 } },
      {
        type: "TEXT",
        content: {
          text: "We'll be sending you carefully curated tips, inspiration, and guidance to help you plan the wedding of your dreams. From setting your vision to walking down the aisle, we've got you covered every step of the way.",
        },
      },
      { type: "SPACER", content: { height: 15 } },
      {
        type: "TEXT",
        content: {
          text: "As professional wedding photographers, we've had the privilege of capturing hundreds of love stories, and we've learned what makes weddings truly magical. We're excited to share that wisdom with you!",
        },
      },
      { type: "SPACER", content: { height: 20 } },
      {
        ...
        content: {
          ...
          url: `mailto:${photographer.emailFromAddr || "hello@business.com"}`,
        },
      },
    ],
    ...
    [
      {
        type: "HEADING",
        content: { text: "Setting Your Wedding Vision", level: "h2" },
      },
      { type: "SPACER", content: { height: 20 } },
      {
        type: "TEXT",
        content: {
          text: "Now that you're engaged, it's time to start dreaming about your perfect wedding day! Let's establish a strong foundation for your planning process.",
        },
      },
      { type: "SPACER", content: { height: 15 } },
      ...
      { type: "SPACER", content: { height: 15 } },
      {
        type: "TEXT",
        content: {
          text: "💡 Pro Tip: Create a shared Pinterest board with your partner to collect ideas and ensure you're both aligned on the vision!",
        },
      },
      { type: "SPACER", content: { height: 15 } },
      {
        type: "TEXT",
        content: {
          text: "Remember, this is YOUR day - let your personalities shine through every decision you make.",
        },
      },
    ],
    ...
    [
      {
        type: "HEADING",
        content: { text: "Wedding Budget Planning Made Simple", level: "h2" },
      },
      { type: "SPACER", content: { height: 20 } },
      {
        type: "TEXT",
        content: {
          text: "Creating a realistic budget is one of the most important steps in wedding planning. Here are practical strategies to help you manage your wedding finances effectively.",
        },
      },
      { type: "SPACER", content: { height: 15 } },
      {
      ...
      { type: "SPACER", content: { height: 15 } },
      {
        type: "TEXT",
        content: {
          text: "Remember: Every detail should reflect your unique love story. Take time to enjoy this planning process!",
        },
      },
    ],
  ];
  ...
  const additionalEmailTopics = [
    {
      ...
      tip: "Visit venues at the same time of day as your wedding to see lighting",
    },
    {
      title: "Building Your Dream Team",
      tip: "Interview at least 3 vendors in each category before deciding",
    },
    {
      title: "Photography Styles Explained",
      tip: "Look at full wedding galleries, not just highlight reels",
    },
    {
      title: "Planning Your Engagement Session",
      tip: "Choose a location that's meaningful to your relationship",
    },
    {
      title: "Wedding Dress Shopping",
      tip: "Bring only 2-3 trusted opinions to avoid overwhelm",
    },
    {
      title: "Groom's Attire Guide",
      tip: "Order suits 3-4 months before the wedding for alterations",
    },
    {
      title: "Menu & Catering Insights",
      tip: "Schedule your tasting when you're hungry for honest feedback",
    },
    {
      title: "Music & Entertainment",
      tip: 'Create a "do not play" list along with your requests',
    },
    {
      title: "Flowers & Decor Ideas",
      tip: "Choose seasonal flowers to save money and ensure freshness",
    },
    {
      title: "Guest List Management",
      tip: "Be consistent with your invitation criteria to avoid hurt feelings",
    },
    {
      title: "Invitations & Stationery",
      tip: "Order 10-15 extra invitations for keepsakes",
    },
    {
      title: "Wedding Registry Essentials",
      tip: "Include items at various price points for all budgets",
    },
  ];
  ...
  for (const topic of additionalEmailTopics) {
    emailBlocksArray.push([
      ...
      { type: "SPACER", content: { height: 20 } },
      {
        type: "TEXT",
        content: {
          text: "As you continue planning your special day, remember that every detail should reflect your unique love story.",
        },
      },
      { type: "SPACER", content: { height: 15 } },
    ...
    emailBlocksArray.push([
      {
        type: "HEADING",
        content: {
          text: email.subject.replace(/^(Your |Wedding |Planning )/g, ""),
          level: "h2",
        },
      },
      { type: "SPACER", content: { height: 20 } },
      ...
      { type: "SPACER", content: { height: 15 } },
      {
        type: "TEXT",
        content: {
          text: "We're here to help capture those precious moments that make your wedding uniquely yours.",
        },
      },
    ]);
  }
  ...
  emails: [
    {
      ...
      htmlBody: "",
      textBody:
        "Thank you for considering us for your portrait session! We're excited to help capture your unique personality.",
    },
    {
      sequenceIndex: 1,
      ...
      htmlBody: "",
      textBody:
        "Let's ensure you're fully prepared for a stunning portrait session with our expert preparation tips.",
    },
    {
      sequenceIndex: 2,
      ...
      htmlBody: "",
      textBody:
        "Your outfit choices can make or break your portraits. Here's how to select the perfect looks.",
    },
    {
      sequenceIndex: 3,
      ...
      htmlBody: "",
      textBody:
        "Learn the secrets to looking relaxed and confident in front of the camera.",
    },
    {
      sequenceIndex: 4,
      ...
      htmlBody: "",
      textBody:
        "Discover the perfect locations that will complement your portrait style and personality.",
    },
  ],
};

// Portrait campaign content
export function generatePortraitEmailContent(
  photographer: Photographer,
): StaticCampaignTemplate {
  const emailBlocksArray = [
    // Email 0: Welcome
    [
      {
        type: "HEADING",
        content: { text: "Welcome to Your Portrait Journey! 📸", level: "h2" },
      },
      { type: "SPACER", content: { height: 20 } },
      {
        type: "TEXT",
        content: {
          text: "Thank you for considering us for your portrait session! We're excited about the opportunity to capture your unique personality and style through beautiful, timeless photography.",
        },
      },
      { type: "SPACER", content: { height: 15 } },
      {
        type: "TEXT",
        content: {
          text: "We'll be sharing valuable tips and insights to help you prepare for an amazing portrait experience. From outfit selection to posing guidance, we want to ensure you feel confident and look your absolute best.",
        },
      },
      { type: "SPACER", content: { height: 20 } },
      {
    ...
    [
      {
        type: "HEADING",
        content: { text: "Preparing for Your Portrait Session", level: "h2" },
      },
      { type: "SPACER", content: { height: 20 } },
      {
        type: "TEXT",
        content: {
          text: "Let's make sure you're fully prepared to create stunning images that you'll treasure forever!",
        },
      },
      { type: "SPACER", content: { height: 15 } },
      {
        type: "HEADING",
        content: { text: "Preparation Essentials:", level: "h3" },
      },
      {
        type: "TEXT",
        content: {
          text: "• Choose outfits that reflect your personal style\n• Consider bringing multiple outfit options\n• Think about meaningful props or accessories\n• Plan your hair and makeup for a polished look",
        },
      },
      { type: "SPACER", content: { height: 15 } },
      {
        type: "TEXT",
        content: {
          text: "💡 Pro Tip: Solid colors and classic styles photograph beautifully and won't date your images!",
        },
      },
    ],
    ...
    [
      {
        type: "HEADING",
        content: { text: "Choosing the Perfect Outfits", level: "h2" },
      },
      { type: "SPACER", content: { height: 20 } },
      {
        type: "TEXT",
        content: {
          text: "Your outfit choices can make or break your portrait session. Here's how to select looks that photograph beautifully:",
        },
      },
      { type: "SPACER", content: { height: 15 } },
      {
      ...
      { type: "SPACER", content: { height: 15 } },
      {
        type: "TEXT",
        content: {
          text: "💡 Bring layers and accessories to create variety in your portraits!",
        },
      },
    ],
    // Email 3: Posing Tips
    [
      {
        type: "HEADING",
        content: { text: "Natural Posing Tips", level: "h2" },
      },
      { type: "SPACER", content: { height: 20 } },
      {
        type: "TEXT",
        content: {
          text: "Looking natural and confident in photos is easier than you think! Here are our top posing tips:",
        },
      },
      { type: "SPACER", content: { height: 15 } },
      {
      ...
      { type: "SPACER", content: { height: 15 } },
      {
        type: "TEXT",
        content: {
          text: "Remember: The best portraits capture authentic emotions and genuine expressions!",
        },
      },
    ],
    ...
    [
      {
        type: "HEADING",
        content: { text: "Perfect Location Ideas", level: "h2" },
      },
      { type: "SPACER", content: { height: 20 } },
      {
        type: "TEXT",
        content: {
          text: "The right location can elevate your portraits from good to extraordinary:",
        },
      },
      { type: "SPACER", content: { height: 15 } },
      {
      ...
      { type: "SPACER", content: { height: 15 } },
      {
        type: "TEXT",
        content: {
          text: "💡 The best location is one where you feel comfortable and confident!",
        },
      },
    ],
  ];
  ...
  emails: [
    {
      ...
      htmlBody: "",
      textBody:
        "Thank you for reaching out about your commercial photography needs! We're excited to help elevate your brand.",
    },
    {
      sequenceIndex: 1,
      ...
      htmlBody: "",
      textBody:
        "Strategic planning is key to successful commercial photography that delivers real business results.",
    },
    {
      sequenceIndex: 2,
      ...
      htmlBody: "",
      textBody:
        "Your visual identity should be consistent, memorable, and perfectly aligned with your brand values.",
    },
    {
      sequenceIndex: 3,
      ...
      htmlBody: "",
      textBody:
        "Learn how to get the most value from your commercial photography across all marketing channels.",
    },
    {
      sequenceIndex: 4,
      ...
      htmlBody: "",
      textBody:
        "Smart commercial photography planning ensures your images work across websites, social media, and print.",
    },
  ],
};

// Commercial campaign content
export function generateCommercialEmailContent(
  photographer: Photographer,
): StaticCampaignTemplate {
  const emailBlocksArray = [
    createSimpleEmailBlocks(
      "Welcome to Professional Brand Photography! 🚀",
      ...
      `mailto:${photographer.emailFromAddr || "hello@business.com"}`,
    ),
    createSimpleEmailBlocks(
      "Planning Your Commercial Photography Strategy",
      "Strategic planning ensures your photography investment delivers maximum value for your business.",
      [
        "• Define your brand's visual identity and message",
        "• Plan for various formats and orientations",
        "• Think about your target audience",
        "💡 Invest in versatile images that work across channels",
      ],
    ),
    createSimpleEmailBlocks(
      ...
      [
        "• Consistent color palettes and styling",
        "• Professional quality builds credibility",
        "• Authentic representation of your values",
      ],
    ),
    createSimpleEmailBlocks(
      "Maximizing ROI from Your Photography",
      "Smart businesses know commercial photography is an investment. Here's how to maximize your return:",
      [
        "• Plan shoots for multiple asset types",
        "• Think long-term and seasonal usage",
        "💡 One well-planned shoot can provide months of content",
      ],
    ),
    createSimpleEmailBlocks(
      ...
      [
        "• Square crops for Instagram and Facebook",
        "• Horizontal formats for website headers",
        "• Vertical orientations for Stories",
  ...
  return {
    ...
    emails: COMMERCIAL_EMAIL_TEMPLATES.emails.map((email, index) => ({
      ...
      htmlBody: generateEmailHTML(
        photographer,
        email.subject,
        "<p>Beautiful commercial content</p>",
        false,
        index,
      ),
      emailBlocks: JSON.stringify(emailBlocksArray[index] || []),
  ...
  emails: [
    {
      ...
      htmlBody: "",
      textBody:
        "Congratulations on your engagement! We're honored to capture this exciting chapter of your love story.",
    },
    {
      sequenceIndex: 1,
      ...
      htmlBody: "",
      textBody:
        "Let's plan an engagement session that perfectly reflects your unique relationship and love story.",
    },
    {
      sequenceIndex: 2,
      ...
      htmlBody: "",
      textBody:
        "The right location adds depth and meaning to your engagement photos. Here's how to choose perfectly.",
    },
    {
      sequenceIndex: 3,
      ...
      htmlBody: "",
      textBody:
        "Learn how to coordinate your outfits for engagement photos that look harmonious and stylish.",
    },
    {
      sequenceIndex: 4,
      ...
      htmlBody: "",
      textBody:
        "The best engagement photos happen when you're relaxed and enjoying each other's company.",
    },
  ],
};

// Engagement campaign content
export function generateEngagementEmailContent(
  photographer: Photographer,
): StaticCampaignTemplate {
  const emailBlocksArray = [
    createSimpleEmailBlocks(
    ...
    createSimpleEmailBlocks(
      ...
      [
        ...
        "• Coordinate complementary outfits",
        "• Plan for golden hour lighting",
    ...
    createSimpleEmailBlocks(
      ...
      [
        ...
        "• Your favorite place together",
        "💕 Choose places with special memories",
      ],
    ),
    createSimpleEmailBlocks(
  ...
  return {
    ...
    emails: ENGAGEMENT_EMAIL_TEMPLATES.emails.map((email, index) => ({
      ...
      htmlBody: generateEmailHTML(
        photographer,
        email.subject,
        "<p>Beautiful engagement content</p>",
        false,
        index,
      ),
      emailBlocks: JSON.stringify(emailBlocksArray[index] || []),
  ...
  emails: [
    {
      ...
      htmlBody: "",
      textBody:
        "Congratulations on your pregnancy! We're thrilled to help document this beautiful journey.",
    },
    {
      sequenceIndex: 1,
      ...
      htmlBody: "",
      textBody:
        "Let's plan a maternity session that celebrates this amazing chapter and the miracle of new life.",
    },
    {
      sequenceIndex: 2,
      ...
      htmlBody: "",
      textBody:
        "Timing is everything for maternity photos. Here's when to schedule for the most beautiful results.",
    },
    {
      sequenceIndex: 3,
      ...
      htmlBody: "",
      textBody:
        "Choose outfits that celebrate your beautiful bump and make you feel confident and radiant.",
    },
    {
      sequenceIndex: 4,
      ...
      htmlBody: "",
      textBody:
        "Including your partner and children creates beautiful family memories during this special time.",
    },
  ],
};

// Maternity campaign content
export function generateMaternityEmailContent(
  photographer: Photographer,
): StaticCampaignTemplate {
  const emailBlocksArray = [
    createSimpleEmailBlocks(
    ...
    createSimpleEmailBlocks(
      ...
      [
        "• Schedule between 28-36 weeks",
        "• Choose flowing, fitted dresses",
        "• Include partner and children",
        "💡 Comfort is key - bring layers!",
      ],
    ),
    createSimpleEmailBlocks(
      "Perfect Timing for Your Photos",
      "When to schedule for the most beautiful results:",
      [
        "• 28-32 weeks: Perfect bump size",
        "• 33-36 weeks: Maximum bump",
        "• Consider your energy levels",
        "💡 Book early, schedule for optimal window",
      ],
    ),
    createSimpleEmailBlocks(
      ...
      [
        "• Fitted dresses that show your bump",
        "• Flowing fabrics like chiffon",
    ...
    createSimpleEmailBlocks(
      ...
      [
        "• Partner touching or kissing your bump",
        "• Siblings giving kisses",
        "• Family hands forming heart",
        "💕 These moments capture the love surrounding your baby",
      ],
    ),
  ];
  ...
  return {
    ...
    emails: MATERNITY_EMAIL_TEMPLATES.emails.map((email, index) => ({
      ...
      htmlBody: generateEmailHTML(
        photographer,
        email.subject,
        "<p>Beautiful maternity content</p>",
        false,
        index,
      ),
      emailBlocks: JSON.stringify(emailBlocksArray[index] || []),
  ...
  emails: [
    {
      ...
      htmlBody: "",
      textBody:
        "Thank you for choosing us to capture your family's precious moments! We're excited to create beautiful memories.",
    },
    {
      sequenceIndex: 1,
      ...
      htmlBody: "",
      textBody:
        "Let's ensure your family session is enjoyable for everyone and results in authentic, beautiful photos.",
    },
    {
      sequenceIndex: 2,
      ...
      htmlBody: "",
      textBody:
        "Coordinate your family's outfits for photos that look harmonious without being too matchy-matchy.",
    },
    {
      sequenceIndex: 3,
      ...
      htmlBody: "",
      textBody:
        "Discover the secrets to capturing natural, joyful expressions from children during family sessions.",
    },
    {
      sequenceIndex: 4,
      ...
      htmlBody: "",
      textBody:
        "Transform your family photo session into a fun experience that creates lasting memories.",
    },
  ],
};

// Family campaign content
export function generateFamilyEmailContent(
  photographer: Photographer,
): StaticCampaignTemplate {
  const emailBlocksArray = [
    createSimpleEmailBlocks(
      "Welcome to Your Family Photography Experience! 👨‍👩‍👧‍👦",
    ...
    createSimpleEmailBlocks(
      "Planning a Fun Family Session",
      "Make your session fun and relaxed for everyone:",
      [
        "• Coordinate outfits (don't match exactly)",
        "• Plan around children's best times",
        "• Bring snacks and small rewards",
        "💡 Let kids be kids!",
      ],
    ),
    createSimpleEmailBlocks(
      ...
      [
        ...
        "💡 Think coordination, not uniformity",
      ],
    ),
    createSimpleEmailBlocks(
      "Tips for Great Photos with Children",
      "Capture natural, joyful expressions:",
      [
        "• Schedule during their best time",
        "• Bring favorite snacks and toys",
        "• Let them run and play naturally",
        "💡 Use games for genuine smiles",
      ],
    ),
    createSimpleEmailBlocks(
      ...
      [
        "• Focus on connection and interaction",
        "• Embrace candid moments",
        "• Include family activities",
        "💕 The best photos tell your story together",
      ],
    ),
  ];
...
// NOTE: Default templates have been disabled to provide a cleaner UI experience.
// Photographers now create their own custom campaigns from scratch using the campaign builder.
export function getStaticCampaigns(
  photographer: Photographer,
): StaticCampaignTemplate[] {
  // Return empty array - no default templates shown
  return [];
}

export function getStaticCampaignByType(
  photographer: Photographer,
  projectType: string,
): StaticCampaignTemplate | null {
  // Return null - no default templates available
  return null;
}
