...
/**
 * Generates a safe random slug as fallback
...
/**
 * Generates a valid, safe slug from a business name
 * Falls back to a random slug if the business name produces invalid results
 */
