...
import ProjectDetailPreview from "@/pages/project-detail-preview";
import Inbox from "@/pages/inbox";
import Templates from "@/pages/templates-new";
import Automations from "@/pages/automations";
import AutomationsPreview from "@/pages/automations-preview";
...
import SlugBookingCalendar from "@/pages/slug-booking-calendar";
    ...
    return (
      <>
        ...
        <Switch>
          ...
          <Route path="/project-preview" component={ProjectDetailPreview} />
        </Switch>
      </>
    );
  }
      ...
      <SidebarProvider fixedHeight={location === "/inbox"} defaultOpen={false}>
        ...
        <SidebarInset>
          ...
          <Switch>
            ...
            <Route path="/automations-preview" component={AutomationsPreview} />
            <Route path="/drip-campaigns" component={DripCampaigns} />
            <Route path="/drip-campaigns/:id/edit" component={CampaignEditor} />
