...
export default function Login() {
  ...
  const isClientPortal =
    domain?.type === "client_portal" && domain.isCustomSubdomain;
  ...
  const requestMagicLinkMutation = useMutation({
    mutationFn: async (email: string) => {
      return await apiRequest("POST", "/api/client-portal/request-magic-link", {
        email,
      });
    },
    onSuccess: () => {
  ...
  if (domainError && !domain) {
    console.error(
      "Domain lookup failed, falling back to photographer login:",
      domainError,
    );
    ...
    <>
          ...
          <div>
            ...
            {isClientPortal && domain?.photographer && (
              <div className="text-center mb-10">
                ...
                <div
                  ...
                  style={{ backgroundColor: brandSecondary, opacity: 0.3 }}
                />
              </div>
            )}
            ...
            <div className="text-center mb-8">
              <h1
                ...
                style={{ color: isClientPortal ? "#111827" : undefined }}
              >
                Welcome back
              </h1>
            ...
            {/* Magic Link Option FIRST - Client Portal Only */}
            {isClientPortal && (
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="text-right">
                  <button
                    ...
                    style={{
                      color: isClientPortal ? brandSecondary : undefined,
                    }}
              ...
              <Button
                ...
                className={
                  isClientPortal
                    ? "w-full h-12 rounded-lg font-semibold text-base hover:opacity-90 transition-opacity mt-6"
            ...
            {!isClientPortal && (
              <>
                <div className="relative my-5 max-w-md mx-auto">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 bg-[#F5F1E8] text-gray-500">
                      Or continue with
                    </span>
                  </div>
                </div>
      ...
      >
        ...
        <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[600px]">
          ...
          <div
            className="w-full md:w-2/5 p-8 md:p-12 flex flex-col"
            style={{
              backgroundColor: isClientPortal ? "#ffffff" : "#F5F1E8",
            }}
          >
            ...
            {isClientPortal && domain?.photographer ? (
              <div className="text-center mb-12">
                ...
                <h2
                  className="text-2xl font-semibold mb-1"
                  style={{ color: brandPrimary }}
                  data-testid="text-photographer-name-desktop"
                >
                  {domain.photographer.businessName}
                </h2>
                <p className="text-sm text-gray-500">Client Portal</p>
            ...
            <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button
                  ...
                  className={
                    isClientPortal
                      ? "w-full h-12 rounded-lg font-semibold hover:opacity-90 transition-opacity"
              ...
              <div className="absolute inset-0 flex items-center justify-center p-12">
                <div className="text-center max-w-md">
                  <Sparkles
                    ...
                    style={{ color: brandPrimary, opacity: 0.8 }}
                  />
                  <h3
                  ...
                  <p className="text-lg text-gray-600">
                    Access your galleries, contracts, and project details all in
                    one place
                  </p>
                </div>
              </div>
