        ...
        <div className="relative max-w-7xl mx-auto px-8 py-20">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              No complicated dashboards. No ad accounts to manage. Just
              exclusive, high-quality leads delivered straight to your CRM while
              you focus on booking clients.
            </p>
            <Button
              size="lg"
        ...
        <div className="mb-32">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Three steps to start generating exclusive leads for your
              ...
              <div className="relative group" data-testid="step-1">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Choose your monthly ad spend between $500-$10,000. We handle
                    all campaign setup, management, and optimization. No Google
                    or Facebook accounts needed.
                  </p>
                </div>
              </div>
              ...
              <div className="relative group" data-testid="step-2">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    master Google Ads MCC and Facebook Business Manager
                    accounts. Daily optimization included.
                  </p>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="md:row-span-2 p-8 rounded-3xl bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/20 hover:border-green-500/30 transition-colors">
              ...
              <p className="text-muted-foreground mb-6 text-lg leading-relaxed">
                Every lead generated from your campaigns belongs to you and you
                alone. Unlike lead marketplaces that sell the same lead to 5+
                photographers, your advertising budget generates contacts that
                go directly into your CRM.
              </p>
              <div className="inline-flex items-center gap-3 p-4 bg-green-500/10 rounded-xl border border-green-500/20">
                <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0" />
                <p className="text-sm font-medium">
                  No competition—they contact you first
                </p>
              </div>
            </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground mb-6 max-w-2xl">
                    See exactly how your advertising budget is performing with
                    real-time metrics and detailed reporting.
                  </p>
                </div>
              </div>
