...
import { Plus, MessageSquare, Mail, Smartphone, Edit, Trash2, ChevronDown, ArrowRight, Link2 } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-sm text-muted-foreground">Rich email with buttons and variables</p>
                      </div>
                    </div>
...
Thank you for reaching out! I'm excited to learn more about your special day..."
                  ...
                  <div className="flex justify-end space-x-2 pt-4 border-t">
                    ...
                    <Button
                      type="submit"
                      disabled={createTemplateMutation.isPending || (selectedChannel === "EMAIL" && !templateBody.trim())}
