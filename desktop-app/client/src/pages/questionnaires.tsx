...
export default function Questionnaires() {
  ...
  const createQuestionMutation = useMutation({
    mutationFn: async (data: {
      ...
      await apiRequest(
        "POST",
        `/api/questionnaire-templates/${data.templateId}/questions`,
        data,
      );
    },
    onSuccess: () => {
  ...
  const assignMutation = useMutation({
    mutationFn: async ({
      ...
      await apiRequest("POST", `/api/projects/${projectId}/questionnaires`, {
        templateId,
      });
    },
    onSuccess: () => {
      ...
      toast({
        ...
        description:
          "Questionnaire has been assigned to the project successfully.",
      });
    },
    onError: (error: any) => {
      toast({
        ...
        description:
          error.message || "Failed to assign questionnaire. Please try again.",
        variant: "destructive",
      });
    },
  });
    ...
    <div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div>
            ...
            <p className="text-sm md:text-base text-muted-foreground">
              Create questionnaires and assign them to clients
            </p>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Completed "Wedding Day Details" questionnaire
                  </p>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    data-testid="button-view-response-emily"
                  >
                    View Response
                  </Button>
                </div>
              ...
              <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Completed "Photography Preferences" questionnaire
                  </p>
                </div>
                <div className="flex items-center space-x-2">
                  <Badge variant="default">Completed</Badge>
                  <Button
                    variant="outline"
                    size="sm"
                    data-testid="button-view-response-sarah"
                  >
                    View Response
                  </Button>
                </div>
              ...
              <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Pending "Wedding Day Details" questionnaire
                  </p>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    data-testid="button-remind-jennifer"
                  >
                    Send Reminder
                  </Button>
                </div>
      ...
      <Dialog open={assignDialogOpen} onOpenChange={setAssignDialogOpen}>
        <DialogContent>
          ...
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Assign "{selectedTemplate?.title}" to a project. Select a project
              below.
            </p>
            ...
            {Array.isArray(projects) && projects.length > 0 ? (
              ...
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-sm">
                  Create a project first to assign questionnaires
                </p>
              </div>
            )}
