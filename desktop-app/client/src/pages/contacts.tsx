...
import { Plus, Search, Mail, Phone, Calendar, Trash2, Eye, MoreHorizontal, Archive, ArchiveRestore, Users, X, ChevronRight, Loader2 } from "lucide-react";
              ...
              >
                <TableCell className="font-medium">
                  <div className="flex items-center gap-3">
                    <div className={`w-9 h-9 rounded-full flex items-center justify-center text-sm font-semibold text-white shrink-0 ${getAvatarColor(client.id)}`}>
          ...
          return (
            ...
            >
              ...
              <div
                className={cn(
                  "h-1 w-full",
                  (client.projects?.length || 0) > 0 ? "bg-green-500" : "bg-gray-200 dark:bg-slate-700"
                )}
              />
              <div className="p-4 space-y-3">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-3 min-w-0 flex-1">
                    <div className={`w-11 h-11 rounded-full flex items-center justify-center text-sm font-semibold text-white shrink-0 ${getAvatarColor(client.id)}`}>
                      {getInitials(client.firstName, client.lastName)}
                    </div>
...
export default function Contacts() {
  ...
  const { data: clients, isLoading, isError } = useQuery<ContactWithProjects[]>({
