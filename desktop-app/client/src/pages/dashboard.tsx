          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-muted-foreground mt-1 flex items-center gap-2">
                ...
                {stats?.newLeads ? `${stats.newLeads} new leads` : 'No new leads'}
                {' '}&bull;{' '}
                {upcomingBookings.length ? `${upcomingBookings.length} upcoming ${upcomingBookings.length === 1 ? 'appointment' : 'appointments'}` : 'No upcoming appointments'}
              </p>
            </div>
          </div>
                ...
                {upcomingBookings.length === 0 ? (
                  <div className="text-center py-8 relative overflow-hidden rounded-lg bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-950/20 dark:to-blue-950/20">
                    ...
                    <div className="relative">
                      ...
                      <p className="text-sm font-medium text-gray-700 dark:text-gray-300">No upcoming appointments</p>
                    ...
                    {upcomingBookings.slice(0, 3).map((booking: any) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-medium truncate">{booking.project?.title || 'Appointment'}</p>
              ...
              {recentProjects.length === 0 ? (
                <div className="text-center py-8 relative overflow-hidden rounded-lg bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/20 dark:to-pink-950/20">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Start by creating your first project</p>
                    <Button
                      size="sm"
              ...
              <CardContent>
                <div className="text-center py-8 relative overflow-hidden rounded-lg bg-gradient-to-br from-indigo-50 to-violet-50 dark:from-indigo-950/20 dark:to-violet-950/20">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Activity tracking coming soon</p>
                    <p className="text-xs text-muted-foreground mt-1">View your projects for current status</p>
                    <Button
                      size="sm"
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 text-white">
                    <p className="text-sm text-emerald-100">This month's revenue</p>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className={cn(
                      ...
                      <p className={cn(
                        ...
                        (stats?.pendingPayments || 0) > 0 ? "text-amber-600 dark:text-amber-400" : ""
                      )}>
                    ...
                    <div className={cn(
                      ...
                      <p className="text-xs text-muted-foreground relative">Overdue</p>
                      <p className={cn(
                        "text-lg font-semibold relative",
                        (stats?.overduePayments || 0) > 0 ? "text-red-600 dark:text-red-400" : ""
                      )}>
