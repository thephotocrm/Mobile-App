        ...
        >
          ...
          <div className="relative h-full flex items-end p-6 md:p-8">
            <div className="text-white max-w-4xl">
              <h1
                className="text-3xl md:text-4xl font-semibold tracking-wide mb-2 drop-shadow-lg"
        ...
        {activeTab === "overview" && (
          <div className="space-y-6 max-w-6xl">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Send a message to {project.photographer.businessName}
                      </p>
                    </div>
                  </div>
                  <Button
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Quick Stats Cards */}
              <Card
                className="bg-white border-gray-200 transition-all duration-300 hover:shadow-lg"
                data-testid="card-tasks-stat"
              >
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold text-gray-900">
                        {project.checklistItems?.filter((i) => i.completedAt)
                          .length || 0}
              ...
              <Card
                className="bg-white border-gray-200 transition-all duration-300 hover:shadow-lg"
                data-testid="card-galleries-stat"
              >
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
          ...
          <div className="space-y-6 max-w-4xl">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                View invoices, contracts, and documents.
              </p>
            </div>
              ...
              <CardContent className="pt-6">
                {!project.smartFiles || project.smartFiles.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-sm text-gray-500 mt-2">
                      Your invoices, contracts, and documents will appear here.
                    </p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {project.smartFiles.map((smartFile) => (
                      <div
                        ...
                        data-testid={`smartfile-card-${smartFile.id}`}
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center space-x-2 mb-2">
                              ...
                              <Badge
                                variant={getStatusColor(smartFile.status)}
                                className="text-xs"
                              >
                                {smartFile.status}
                              </Badge>
                            ...
                            {smartFile.totalCents > 0 && (
                              <p className="text-2xl font-bold text-gray-900">
                                {formatPrice(smartFile.totalCents)}
                              </p>
                            )}
                          </div>
                          <Button
                    ...
                    {project.galleries.map((gallery) => (
                      ...
                      >
                        ...
                        <Button
                          ...
                          className="w-full"
                          onClick={() =>
                            setLocation(`/client/galleries/${gallery.id}`)
                          }
        ...
        {activeTab === "payments" && (
          <div className="space-y-6 max-w-4xl">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                View and manage your invoices and contracts.
              </p>
            </div>
            <ClientPortalPaymentsSection
              projectId={projectId!}
              onNavigateToSmartFile={(token) =>
                window.open(`/smart-file/${token}`, "_blank")
              }
            />
          </div>
        )}
              ...
              <CardContent className="pt-6">
                ...
                project.checklistItems.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-sm text-gray-500 mt-2">
                      Your photographer will assign tasks here.
                    </p>
                  </div>
                ) : (
                  <div className="space-y-3">
                ...
                {!project.notes || project.notes.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {project.notes.map((note) => (
                      <div
                        key={note.id}
                        className="border border-gray-200 rounded-lg p-4 bg-yellow-50 border-yellow-200"
