...
import { ClientPortalPaymentsSection } from "@/components/client-portal-payments-section";
import { 
  Calendar,
  Mail,
  Phone,
...
export default function ClientPortalProject() {
  ...
  return (
    <ClientPortalLayout currentProjectId={projectId}>
        {/* Cover Photo Hero Banner - Only show on Overview tab */}
        {activeTab === 'overview' && (
          <div
            className="relative h-52 md:h-80 w-full bg-cover bg-center bg-gray-100"
          ...
          >
            ...
            <div className="relative h-full flex items-end p-6 md:p-8">
              <div className="text-white max-w-4xl">
                <h1 className="text-3xl md:text-4xl font-semibold tracking-wide mb-2 drop-shadow-lg" data-testid="text-project-title">
                  {project.title}
                </h1>
        ...
        <div className="p-4 md:p-8">
          ...
          {activeTab === 'overview' && (
            <div className="space-y-6 max-w-6xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Quick Stats Cards */}
                <Card className="bg-white border-gray-200 transition-all duration-300 hover:shadow-lg" data-testid="card-tasks-stat">
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                ...
                <Card className="bg-white border-gray-200 transition-all duration-300 hover:shadow-lg" data-testid="card-files-stat">
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                ...
                <Card className="bg-white border-gray-200 transition-all duration-300 hover:shadow-lg" data-testid="card-galleries-stat">
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
              ...
              {project.activities && project.activities.length > 0 && (
                <Card className="bg-white border-gray-200 transition-all duration-300 hover:shadow-lg">
                  <CardHeader>
                    <CardTitle className="text-xl tracking-wide">Recent Activity</CardTitle>
                  </CardHeader>
                  <CardContent>
          ...
          {activeTab === 'activity' && (
            <div className="space-y-6 max-w-4xl">
              <h1 className="text-3xl font-semibold tracking-wide text-gray-900">Messages & Activity</h1>

              {/* Inline Email Composer - HoneyBook Style */}
              <Card className="bg-white border-gray-200 transition-all duration-300">
                <CardContent className="p-6">
                                ...
                                <div className="flex gap-4">
                                  ...
                                  <Avatar className="w-10 h-10 flex-shrink-0">
                                    <AvatarFallback className="bg-gray-900 text-white text-sm font-medium">
                                      {senderName.split(' ').map((n: string) => n[0]).join('').substring(0, 2).toUpperCase()}
                                    </AvatarFallback>
                                  </Avatar>
          ...
          {activeTab === 'files' && (
            <div className="space-y-6 max-w-4xl">
              <div>
                <h1 className="text-3xl font-semibold tracking-wide text-gray-900">Files</h1>
                      ...
                      {project.smartFiles.map((smartFile) => (
                        <div key={smartFile.id} className="border border-gray-200 rounded-lg p-4 hover:border-primary transition-colors" data-testid={`smartfile-card-${smartFile.id}`}>
                          <div className="flex items-start justify-between">
                            ...
                            <Button
                              onClick={() => window.open(`/smart-file/${smartFile.token}`, '_blank')}
          ...
          {activeTab === 'galleries' && (
            <div className="space-y-6 max-w-4xl">
              <div>
                <h1 className="text-3xl font-semibold tracking-wide text-gray-900">Galleries</h1>
          ...
          {activeTab === 'payments' && (
            <div className="space-y-6 max-w-4xl">
              ...
              <ClientPortalPaymentsSection
                projectId={projectId!}
                onNavigateToSmartFile={(token) => window.open(`/smart-file/${token}`, '_blank')}
              />
            </div>
          )}
          ...
          {activeTab === 'tasks' && (
            <div className="space-y-6 max-w-4xl">
              <h1 className="text-3xl font-semibold tracking-wide text-gray-900">Tasks</h1>
              <Card className="bg-white border-gray-200 transition-all duration-300 hover:shadow-lg">
                <CardContent className="pt-6">
          ...
          {activeTab === 'notes' && (
            <div className="space-y-6 max-w-4xl">
              <h1 className="text-3xl font-semibold tracking-wide text-gray-900">Notes</h1>
              <Card className="bg-white border-gray-200 transition-all duration-300 hover:shadow-lg">
                <CardContent className="pt-6">
