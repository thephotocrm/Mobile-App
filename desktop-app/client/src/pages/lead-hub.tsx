...
export default function LeadHub() {
  ...
  const filteredContacts = contacts.filter((contact) => {
    ...
    const matchesSource =
      filterSource === "all" || contact.leadSource === filterSource;
  ...
  const getSourceBadgeVariant = (source: string) => {
    if (source.includes("WEBSITE") || source.includes("WIDGET"))
      return "default";
          ...
          <CardContent>
            <div className="flex items-center gap-2">
              ...
              <div>
                <div
                  className="text-3xl font-bold"
                  data-testid="text-monthly-leads"
                >
                  {thisMonth}
                </div>
                    ...
                    <div className="flex items-start justify-between gap-4 mb-2">
                      <div>
                        <h3
                          ...
                          data-testid={`text-lead-name-${contact.id}`}
                        >
                          {contact.firstName} {contact.lastName || ""}
                        </h3>
                        <div className="flex items-center gap-2 mt-1">
                          <Badge
                            variant={getSourceBadgeVariant(contact.leadSource)}
