...
const MOCK_CONTACTS_DATA: Record<string, {
  id: string;
  name: string;
  email: string;
  phone: string;
  ...
  role: string;
  notes?: string;
  projects: Array<{ id: string; title: string; stage: string; stageColor: string; eventDate: string }>;
}> = {
  '1': {
    id: '1',
    name: 'Sarah Johnson',
    ...
    projects: [
      { id: '1', title: 'Sarah & Mike Wedding', stage: 'Booked', stageColor: '#3B82F6', eventDate: 'June 15, 2025' },
    ],
  },
  '2': {
    id: '2',
  ...
  '3': {
    ...
    projects: [
      { id: '1', title: 'Sarah & Mike Wedding', stage: 'Booked', stageColor: '#3B82F6', eventDate: 'June 15, 2025' },
      { id: '2', title: 'Emily & David Wedding', stage: 'Active', stageColor: '#22C55E', eventDate: 'August 20, 2025' },
      { id: '3', title: 'Lisa & James Wedding', stage: 'Lead', stageColor: '#F59E0B', eventDate: 'October 10, 2025' },
    ],
  },
  '4': {
    id: '4',
  ...
  '5': {
    ...
    projects: [
      { id: '2', title: 'Emily & David Wedding', stage: 'Active', stageColor: '#22C55E', eventDate: 'August 20, 2025' },
      { id: '4', title: 'Emily & Tom Engagement', stage: 'Completed', stageColor: '#9CA3AF', eventDate: 'March 15, 2024' },
    ],
  },
  '6': {
    id: '6',
  ...
  '7': {
    ...
    projects: [
      { id: '3', title: 'Lisa & James Wedding', stage: 'Lead', stageColor: '#F59E0B', eventDate: 'October 10, 2025' },
      { id: '5', title: 'Lisa Birthday Session', stage: 'Completed', stageColor: '#9CA3AF', eventDate: 'May 5, 2024' },
    ],
  },
  '8': {
    id: '8',
...
type ContactDetailScreenRouteProp = RouteProp<ToolsStackParamList, 'ContactDetail'>;
  ...
  return (
    <ScreenScrollView>
      <View style={[styles.hero, { backgroundColor: theme.backgroundSecondary }]}>
        ...
        <ThemedText style={[styles.heroName, { fontSize: Typography.h2.fontSize, fontWeight: Typography.h2.fontWeight }]}>
          {contact.name}
        </ThemedText>
        ...
        {contact.company ? (
          <ThemedText style={[styles.heroCompany, { color: theme.textSecondary }]}>
            {contact.company}
          </ThemedText>
        ) : null}
      </View>
        ...
        <View style={[styles.infoCard, { backgroundColor: theme.backgroundSecondary }]}>
          ...
          {contact.company ? (
            <View style={[styles.infoRow, styles.infoRowBorder, { borderTopColor: theme.border }]}>
              ...
              <View style={styles.infoContent}>
                <ThemedText style={[styles.infoLabel, { color: theme.textSecondary }]}>Company</ThemedText>
                <ThemedText style={styles.infoValue}>{contact.company}</ThemedText>
              </View>
            </View>
          ) : null}
          ...
          {contact.role ? (
            <View style={[styles.infoRow, styles.infoRowBorder, { borderTopColor: theme.border }]}>
              ...
              <View style={styles.infoContent}>
                <ThemedText style={[styles.infoLabel, { color: theme.textSecondary }]}>Role</ThemedText>
        ...
        {contact.notes ? (
          <>
            ...
            <View style={[styles.notesCard, { backgroundColor: theme.backgroundSecondary }]}>
              <ThemedText style={[styles.notesText, { color: theme.text }]}>{contact.notes}</ThemedText>
            </View>
          </>
        ) : null}
        ...
        {contact.projects.map((project) => (
          ...
          >
            <View style={styles.projectHeader}>
              <ThemedText style={[styles.projectTitle, { fontSize: Typography.body.fontSize, fontWeight: '600' }]}>
                {project.title}
              </ThemedText>
              <Badge label={project.stage} backgroundColor={project.stageColor} />
            </View>
